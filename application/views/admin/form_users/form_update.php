...
<head>
  ...
  <title>AMAN Gudang | Satuan Barang</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Update Data Pengguna</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            ...
            <?php } ?>
              ...
              <div class="form-group" style="display:block;">
                <label for="role" style="width:73%;">Status</label>
                <select class="form-control" name="role" style="width:11%;margin-right: 18px;">
                  ...
                  <option value="0" selected="">Pengguna Biasa</option>
                  <?php } ?>
                </select>
            </div>
            <?php } ?>
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" class="btn btn-info bg-yellow" style="width:13%;margin-right:29%" href="<?=base_url('admin/users')?>" name="btn_listusers"><i class="fa fa-table" aria-hidden="true"></i> Lihat Users</a>
