...
<head>
  ...
  <title>AMAN App | Table Satuan</title>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?= base_url('admin/sigout')?>" class="btn btn-default btn-flat"> Keluar</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= base_url('admin/tabel_satuan')?>"><i class="fa fa-circle-o"></i> Satuan</a></li>
          </ul>
        </li>
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tables</li>
        <li class="active"><a href="<?=base_url('admin/tabel_satuan')?>">Satuan</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="<?=base_url('admin/form_satuan')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary bg-yellow" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
