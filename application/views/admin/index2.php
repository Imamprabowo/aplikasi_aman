      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="fa fa-circle-o"></i> Beranda v1</a></li>
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> Beranda v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
